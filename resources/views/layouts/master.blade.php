                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown user user-menu">
                        ...
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            ...
                            <img src="{{ asset('storage/images/profiles/'.Auth::user()->profile_photo_path) }}" class="user-image" alt="User Image">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <!-- Menu Footer-->
                            <li class="user-footer bg-slate-200 sm:bg-gray-500">
                                <div class="pull-left">
                                <a href="{{ route('profile.index') }}" class="btn btn-primary btn-flat">My Account</a>
                                </div>
                                {{-- testing user profile --}}
                                <div class="pull-left">
                                    <a href="{{ route('account.index') }}" class="btn btn-primary btn-flat">My Account</a>
                                    </div>
